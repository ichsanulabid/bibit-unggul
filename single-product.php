...
if (isset($_POST['add_to_cart'])) {
    ...
    // Menyimpan item keranjang ke dalam session
    ...
    // Jika produk belum ada di keranjang, tambahkan produk sebagai item baru
    if (!$isProductInCart) {
        array_push($_SESSION['cart'], $cartItem);
    }

    // Mengarahkan pengguna ke halaman keranjang
        ...
        <div class="row s_product_inner justify-content-between">
            <div class="col-lg-7 col-xl-7">
                <div class="product_slider_img">
                    <div id="vertical">
                        <div>
                            <img width="1000px" src="img/<?php echo $image['image']; ?>" alt="" />
                        </div>
                    </div>
                </div>
            </div>
