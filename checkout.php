      ...
      <div class="col-lg-8">
        <div class="breadcrumb_iner">
          <div class="breadcrumb_iner_item">
            ...
            <p>Home <span>-</span> Check Out Process</p>
          </div>
        </div>
      </div>
    </div>
...
<section class="checkout_area padding_top">
  <div class="container">
    ...
    <div class="billing_details">
      <div class="row">
        <form class="row contact_form" action="confirmation.php" method="post" novalidate="novalidate" enctype="multipart/form-data">
          <!-- <div class="col-lg-8">
          ...
          <div class="col-lg-4">
            <div class="order_box" style="width: 1150px;">
              <h2>Your Order</h2>
              <ul class="list" style="width: 1080px;">
                <li>
                ...
                while ($row = mysqli_fetch_array($result)) {
                  ...
                  '<li>
                    <a href="#">
                      ...
                      <span class="last">Rp ' . $row['qty'] * $row['price'] . '</span>
                    </a>
                  </li>';
              ...
              <ul class="list list_2" style="width: 1080px;">
                <li>
                  <a href="#">Subtotal
                ...
                <li>
                  <a href="#">Shipping(Rp 10000/product)
                    <span>Rp <?php echo $quantity*10000?></span>
                  </a>
                </li>
                <li>
                  <a href="#">Total
                    <span>Rp <?php echo $sum + 10000*$quantity ?></span>
                  </a>
                </li>
              </ul>
                <br><br>
              <div class="form-group">
                <h2 for="payment_proof">Upload Payment Proof</h2>
